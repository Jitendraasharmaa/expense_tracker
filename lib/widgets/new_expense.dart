...
class NewExpense extends StatefulWidget {
  ...
  final void Function(Expense expense)
      onAddExpense; //passing the function as a value
...
class _NewExpenseState extends State<NewExpense> {
  ...
  void _presentDatePicker() async {
    ...
    // Builder :(BuildContext context) => SizedBox(height: 250,);
    setState(() {
  ...
  void _submitExpenseData() {
    ...
    widget.onAddExpense( //you can use widget to return widget method because it is provided by flutter
      Expense(
